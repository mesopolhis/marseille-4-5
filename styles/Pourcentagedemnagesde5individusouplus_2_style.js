...
var style_Pourcentagedemnagesde5individusouplus_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de ménages de 5 individus ou plus");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 2.780000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.780000 && value <= 5.220000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.220000 && value <= 8.008000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.008000 && value <= 12.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.500000 && value <= 54.550000) {
            style = [ new ol.style.Style({
