...
var style_Pourcentagedemnagespauvres_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de ménages pauvres");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 6.020000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.020000 && value <= 10.218000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.218000 && value <= 15.454000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 15.454000 && value <= 24.390000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24.390000 && value <= 87.500000) {
            style = [ new ol.style.Style({
