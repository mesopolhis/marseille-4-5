...
var style_Pourcentagedelogementsconstruitsentre1970et1989_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de logements construits entre 1970 et 1989");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000000 && value <= 3.306000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.306000 && value <= 10.000000) {
            style = [ new ol.style.Style({
