...
var style_Pourcentagedindividusde010ans_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage d’individus de 0 à 10 ans");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 8.118000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.118000 && value <= 10.816000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.816000 && value <= 13.134000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.134000 && value <= 16.670000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.670000 && value <= 39.290000) {
            style = [ new ol.style.Style({
