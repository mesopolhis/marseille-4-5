...
var style_Pourcentagedindividusde4054ans_17 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage d’individus de 40 à 54 ans");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 17.118000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.118000 && value <= 19.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.500000 && value <= 21.310000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.310000 && value <= 24.452000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24.452000 && value <= 55.000000) {
            style = [ new ol.style.Style({
