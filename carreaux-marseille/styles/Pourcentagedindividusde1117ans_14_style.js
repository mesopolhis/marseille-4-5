...
var style_Pourcentagedindividusde1117ans_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage d’individus de 11 à 17 ans");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 5.450000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.450000 && value <= 7.166000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7.166000 && value <= 8.990000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.990000 && value <= 11.510000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.510000 && value <= 30.770000) {
            style = [ new ol.style.Style({
