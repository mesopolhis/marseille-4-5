...
var style_Pourcentagedemnagesdunseulindividu_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de ménages d’un seul individu");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 18.864000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.864000 && value <= 27.030000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 27.030000 && value <= 34.070000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.070000 && value <= 42.278000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 42.278000 && value <= 92.310000) {
            style = [ new ol.style.Style({
