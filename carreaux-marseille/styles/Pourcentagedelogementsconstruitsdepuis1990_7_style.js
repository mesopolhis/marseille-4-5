...
var style_Pourcentagedelogementsconstruitsdepuis1990_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de logements construits depuis 1990");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 6.768000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.768000 && value <= 17.224000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.224000 && value <= 31.250000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 31.250000 && value <= 54.092000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 54.092000 && value <= 100.000000) {
            style = [ new ol.style.Style({
