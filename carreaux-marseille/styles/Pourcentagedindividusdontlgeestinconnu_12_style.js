...
var style_Pourcentagedindividusdontlgeestinconnu_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage d’individus dont l’âge est inconnu");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.600000 && value <= 2.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.500000 && value <= 5.490000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.490000 && value <= 11.140000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.140000 && value <= 17.500000) {
            style = [ new ol.style.Style({
