...
var style_Pourcentagedemnagesmonoparentaux_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de ménages monoparentaux");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 6.670000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.670000 && value <= 10.340000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.340000 && value <= 13.330000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.330000 && value <= 17.532000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.532000 && value <= 54.550000) {
            style = [ new ol.style.Style({
