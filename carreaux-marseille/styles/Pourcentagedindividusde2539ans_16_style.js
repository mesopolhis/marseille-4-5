...
var style_Pourcentagedindividusde2539ans_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage d’individus de 25 à 39 ans");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 11.250000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.250000 && value <= 15.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 15.000000 && value <= 17.584000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.584000 && value <= 21.472000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.472000 && value <= 57.140000) {
            style = [ new ol.style.Style({
