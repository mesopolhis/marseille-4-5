...
var style_Pourcentagedindividusde80ansouplus_20 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage d’individus de 80 ans ou plus");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 2.378000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.378000 && value <= 4.350000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.350000 && value <= 6.234000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.234000 && value <= 8.934000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.934000 && value <= 52.780000) {
            style = [ new ol.style.Style({
