...
var style_Pourcentagedemnagespropritaires_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Pourcentage de ménages propriétaires");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 37.376000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 37.376000 && value <= 58.382000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 58.382000 && value <= 71.740000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 71.740000 && value <= 83.330000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 83.330000 && value <= 100.000000) {
            style = [ new ol.style.Style({
