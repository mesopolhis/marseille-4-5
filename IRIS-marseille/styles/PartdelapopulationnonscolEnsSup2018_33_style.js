...
var style_PartdelapopulationnonscolEnsSup2018_33 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de la population non scol. : Ens. Sup. 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 18.540000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.540000 && value <= 27.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 27.700000 && value <= 37.860000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 37.860000 && value <= 47.440000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 47.440000 && value <= 68.200000) {
            style = [ new ol.style.Style({
