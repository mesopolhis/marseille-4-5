...
var style_PartdefamillesMonoparentales2018_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de familles - Monoparentales 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 16.520000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.520000 && value <= 21.980000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.980000 && value <= 26.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26.300000 && value <= 31.480000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 31.480000 && value <= 56.700000) {
            style = [ new ol.style.Style({
