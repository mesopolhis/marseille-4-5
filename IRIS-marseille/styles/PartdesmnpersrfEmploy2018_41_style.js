...
var style_PartdesmnpersrfEmploy2018_41 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des mén. - pers. réf. : Employé 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 13.640000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.640000 && value <= 16.880000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.880000 && value <= 19.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.600000 && value <= 22.560000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.560000 && value <= 100.000000) {
            style = [ new ol.style.Style({
