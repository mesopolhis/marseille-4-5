...
var style_Partmnemmnagsdepuis10ansou2018_20 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part mén. emménagés depuis 10 ans ou + 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 35.180000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 35.180000 && value <= 44.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 44.500000 && value <= 51.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 51.500000 && value <= 56.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 56.900000 && value <= 100.000000) {
            style = [ new ol.style.Style({
