...
var style_PartmnpersrfArtisan2018_44 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part mén. - pers. réf. : Artisan 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 2.700000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.700000 && value <= 3.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.200000 && value <= 5.560000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.560000 && value <= 35.300000) {
            style = [ new ol.style.Style({
