...
var style_Partdefamilles3enfantsmoins25ans2018_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de familles - 3 enfants (moins 25 ans) 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 3.820000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.820000 && value <= 5.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.500000 && value <= 7.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7.500000 && value <= 10.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.800000 && value <= 23.600000) {
            style = [ new ol.style.Style({
