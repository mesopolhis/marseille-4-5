...
var style_Partdefamilles0enfantmoins25ans2018_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de familles - 0 enfant (moins 25 ans) 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 36.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 36.600000 && value <= 42.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 42.500000 && value <= 46.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 46.900000 && value <= 52.000000) {
            style = [ new ol.style.Style({
