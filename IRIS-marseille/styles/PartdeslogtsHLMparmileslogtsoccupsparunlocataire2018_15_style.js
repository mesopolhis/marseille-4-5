...
var style_PartdeslogtsHLMparmileslogtsoccupsparunlocataire2018_15 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des logts HLM parmi les logts occupés par un locataire 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.620000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.620000 && value <= 6.640000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.640000 && value <= 22.860000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.860000 && value <= 52.920000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 52.920000 && value <= 100.000000) {
            style = [ new ol.style.Style({
