...
var style_PartmnpersrfCSP2018_37 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part mén. - pers. réf. : CSP+ 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 3.740000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.740000 && value <= 7.780000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7.780000 && value <= 12.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.900000 && value <= 18.220000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.220000 && value <= 100.000000) {
            style = [ new ol.style.Style({
