...
var style_Partdesautresrevenusanne2019_29 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des autres revenus (%) -année 2019");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.100000 && value <= 2.100000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.100000 && value <= 3.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.200000 && value <= 4.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.200000 && value <= 6.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.500000 && value <= 35.200000) {
            style = [ new ol.style.Style({
