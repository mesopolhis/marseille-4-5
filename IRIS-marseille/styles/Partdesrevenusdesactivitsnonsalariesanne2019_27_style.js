...
var style_Partdesrevenusdesactivitsnonsalariesanne2019_27 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des revenus des activités non salariées (%) -année 2019");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 2.300000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.300000 && value <= 3.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.800000 && value <= 5.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.200000 && value <= 7.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7.900000 && value <= 16.200000) {
            style = [ new ol.style.Style({
