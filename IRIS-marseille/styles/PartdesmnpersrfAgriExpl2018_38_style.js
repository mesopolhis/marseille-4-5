...
var style_PartdesmnpersrfAgriExpl2018_38 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des mén. - pers. réf. : Agri. Expl. 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000000 && value <= 0.700000) {
            style = [ new ol.style.Style({
