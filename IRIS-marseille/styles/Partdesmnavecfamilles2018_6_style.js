...
var style_Partdesmnavecfamilles2018_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des mén. avec famille(s) 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 46.280000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 46.280000 && value <= 54.280000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 54.280000 && value <= 60.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 60.300000 && value <= 66.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 66.400000 && value <= 100.000000) {
            style = [ new ol.style.Style({
