...
var style_Partdesrevenusdactivitanne2019_32 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des revenus d’activité (%) -année 2019");
    var labelText = "";
    size = 0;
    ...
    if (value >= 48.300000 && value <= 64.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 64.800000 && value <= 68.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 68.000000 && value <= 70.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 70.500000 && value <= 73.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 73.700000 && value <= 90.100000) {
            style = [ new ol.style.Style({
