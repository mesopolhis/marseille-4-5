...
var style_Partpopmnemmnagsdepuismoins2ans2018_19 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part pop. mén. emménagés depuis moins 2 ans 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 8.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.000000 && value <= 10.380000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.380000 && value <= 13.120000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.120000 && value <= 16.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.200000 && value <= 47.100000) {
            style = [ new ol.style.Style({
