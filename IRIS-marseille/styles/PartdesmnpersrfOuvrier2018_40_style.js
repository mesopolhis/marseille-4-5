...
var style_PartdesmnpersrfOuvrier2018_40 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des mén. - pers. réf. : Ouvrier 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 5.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.400000 && value <= 8.580000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.580000 && value <= 11.920000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.920000 && value <= 16.860000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.860000 && value <= 50.000000) {
            style = [ new ol.style.Style({
