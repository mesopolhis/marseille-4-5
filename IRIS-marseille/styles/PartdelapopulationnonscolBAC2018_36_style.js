...
var style_PartdelapopulationnonscolBAC2018_36 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de la population non scol. : BAC 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 5.100000 && value <= 14.300000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 14.300000 && value <= 16.100000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.100000 && value <= 17.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.300000 && value <= 19.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.300000 && value <= 100.000000) {
            style = [ new ol.style.Style({
