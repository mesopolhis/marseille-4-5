...
var style_partdes1529ans2018_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("part des 15-29 ans 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 14.660000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 14.660000 && value <= 16.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.800000 && value <= 19.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.400000 && value <= 22.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.700000 && value <= 86.400000) {
            style = [ new ol.style.Style({
