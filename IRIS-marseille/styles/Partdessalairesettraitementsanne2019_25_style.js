...
var style_Partdessalairesettraitementsanne2019_25 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des salaires et traitements (%) -année 2019");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 54.300000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 54.300000 && value <= 58.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 58.300000 && value <= 60.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 60.700000 && value <= 63.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 63.400000 && value <= 75.900000) {
            style = [ new ol.style.Style({
