...
var style_PartdelapopulationnonscolCAPBEP2018_35 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de la population non scol. : CAP-BEP 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 13.900000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.900000 && value <= 17.720000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.720000 && value <= 20.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20.900000 && value <= 24.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24.400000 && value <= 50.000000) {
            style = [ new ol.style.Style({
