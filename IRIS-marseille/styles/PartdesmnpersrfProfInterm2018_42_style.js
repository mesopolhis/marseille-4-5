...
var style_PartdesmnpersrfProfInterm2018_42 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des mén. -pers. réf. : Prof. Interm. 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 9.840000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 9.840000 && value <= 13.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.900000 && value <= 16.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.800000 && value <= 19.160000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.160000 && value <= 100.000000) {
            style = [ new ol.style.Style({
