...
var style_PartdelapopulationnonscolSansdiplme2018_34 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de la population non scol. : Sans diplôme 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 13.760000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.760000 && value <= 19.020000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.020000 && value <= 25.180000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25.180000 && value <= 35.040000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 35.040000 && value <= 65.900000) {
            style = [ new ol.style.Style({
