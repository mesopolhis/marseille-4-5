...
var style_Partdespensionsretraitesetrentesanne2019_28 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des pensions, retraites et rentes (%) -année 2019");
    var labelText = "";
    size = 0;
    ...
    if (value >= 9.100000 && value <= 21.700000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.700000 && value <= 25.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25.000000 && value <= 27.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 27.700000 && value <= 30.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.400000 && value <= 39.900000) {
            style = [ new ol.style.Style({
