...
var style_Partdefamilles1enfantmoins25ans2018_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part de familles - 1 enfant (moins 25 ans) 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 21.320000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.320000 && value <= 23.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.700000 && value <= 26.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26.300000 && value <= 28.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 28.900000 && value <= 100.000000) {
            style = [ new ol.style.Style({
