...
var style_Partmnagesemmnagsdepuis59ans2018_21 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part ménages emménagés depuis 5 à 9 ans 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 14.100000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 14.100000 && value <= 16.100000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.100000 && value <= 18.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.000000 && value <= 20.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20.800000 && value <= 100.000000) {
            style = [ new ol.style.Style({
