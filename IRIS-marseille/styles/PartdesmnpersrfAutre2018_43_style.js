...
var style_PartdesmnpersrfAutre2018_43 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Part des mén. - pers. réf. : Autre 2018");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 5.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.800000 && value <= 8.480000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.480000 && value <= 12.100000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.100000 && value <= 20.760000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20.760000 && value <= 80.300000) {
            style = [ new ol.style.Style({
