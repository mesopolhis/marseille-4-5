...
var style_Tauxdebasrevenusdclarsauseuilde60anne2019_31 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Taux de bas revenus déclarés au seuil de 60 % (%) -année 2019");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 12.900000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.900000 && value <= 24.300000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24.300000 && value <= 34.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.400000 && value <= 50.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 50.700000 && value <= 85.700000) {
            style = [ new ol.style.Style({
